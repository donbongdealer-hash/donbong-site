...
const POLL_DATA = [
  {id:'freq',title:'How often',subtitle:'do you clean?',options:[
    {id:'daily',text:'Daily',emoji:'✨',score:100},
    {id:'weekly',text:'Weekly',emoji:'🧹',score:70},
    {id:'monthly',text:'Monthly',emoji:'🕸️',score:40},
    {id:'never',text:'Rarely',emoji:'🍄',score:10}
  ]},
  {id:'method',title:'Main cleaning',subtitle:'tool?',options:[
    {id:'ultrasonic',text:'Ultrasonic',emoji:'🔋',score:100},
    {id:'iso',text:'ISO Alcohol',emoji:'🧪',score:90},
    {id:'soap',text:'Soap & Water',emoji:'🧼',score:60},
    {id:'nothing',text:'Just Water',emoji:'🚰',score:30}
  ]},
  {id:'residue',title:'Visible',subtitle:'residue?',options:[
    {id:'none',text:'Crystal Clear',emoji:'💎',score:100},
    {id:'slight',text:'Minor Spots',emoji:'🔍',score:70},
    {id:'cloudy',text:'Cloudy Film',emoji:'🌫️',score:40},
    {id:'heavy',text:'Heavy Buildup',emoji:'🌑',score:10}
  ]},
  {id:'odor',title:'How does',subtitle:'it smell?',options:[
    {id:'fresh',text:'Fresh',emoji:'🌿',score:100},
    {id:'neutral',text:'Neutral',emoji:'⚪',score:80},
    {id:'stale',text:'Stale',emoji:'🍂',score:40},
    {id:'funky',text:'Funky',emoji:'🦨',score:10}
  ]}
];
