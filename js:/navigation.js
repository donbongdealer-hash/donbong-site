...
async function loadBlocks() {
  const blocks = ['announce', 'hero', 'why', 'partners', 'science', 'deals', 'testimonials', 'join', 'story', 'social'];
  for (const block of blocks) {
    try {
      ...
      if (placeholder) {
        ...
        console.warn(`Placeholder for block ${block} not found`);
      }
    } catch (e) {
      console.warn(`Block ${block} not found or error:`, e);
    }
  }
}
